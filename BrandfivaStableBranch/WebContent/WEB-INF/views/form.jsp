...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:51:06 GMT -->
<head>
<meta charset="utf-8">
...
<h4> <a class="inline" href="http://templatecycle.com/cdn-cgi/l/email-protection#2a424f465a6a5e5942455a5d4f4804494547"> <i class="fa fa-envelope-o"> </i> <span class="__cf_email__" data-cfemail="9ef6fbf2eedeeaedf6f1eee9fbfcb0fdf1f3">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">
...
<div class="pull-right paymentMethodImg"> <img height="30" class="pull-right" src="resources/images/site/payment/master_card.png"> <img height="30" class="pull-right" src="resources/images/site/payment/paypal.png"> <img height="30" class="pull-right" src="resources/images/site/payment/american_express_card.png"> <img height="30" class="pull-right" src="resources/images/site/payment/discover_network_card.png"> <img height="30" class="pull-right" src="resources/images/site/payment/google_wallet.png"> </div>
</div>
</div>
</footer>
...
<script src="resources/assets/js/jquery.cycle2.min.js">
</script>
 
<script src="resources/assets/js/jquery.easing.1.3.js">
</script>
 
<script type="text/javascript" src="resources/assets/js/jquery.parallax-1.1.js">
</script>
 
<script type="text/javascript" src="resources/assets/js/helper-plugins/jquery.mousewheel.min.js">
</script>
 
<script type="text/javascript" src="resources/assets/js/jquery.mCustomScrollbar.js">
</script>
 
<script type="text/javascript" src="resources/assets/js/ion-checkRadio/ion.checkRadio.min.js">
</script>
 
<script src="resources/assets/js/grids.js"></script>
  <script src="resources/assets/js/owl.carousel.min.js">
</script>
 
<script type="text/javascript" src="resources/assets/js/smoothproducts.min.js">
</script>
 
<script src="resources/assets/js/jquery.minimalect.min.js">
</script>
 
<script src="resources/assets/js/bootstrap.touchspin.js">
</script>
