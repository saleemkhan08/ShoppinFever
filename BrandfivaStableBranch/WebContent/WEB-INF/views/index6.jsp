...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:49:58 GMT -->
<head>
<meta charset="utf-8">
...
<link href="resources/assets/css/story.css" rel="stylesheet">
...
<div id="story1" class="story  clearfix" style="background-image:url(resources/images/blog/6808161406_d38a36ce37_b.jpg)" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#story1">
<div class="display-table hw100 relative5">
<div class="display-table-cell hw100">
<div class="col-md-6 col-sm-4"> </div>
<div class="col-md-6 col-sm-8">
<div class="storyText text-center" data-center="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#story1 h1">
<h1>your fashion, your style</h1>
<h2>look the best, stand out from the rest</h2>
<p>Quisque et pulvinar sem, sit amet viverra erat. Mauris sed arcu quis orci ornare sagittis sit amet nec purus.</p>
...
<div id="story2" class="story  clearfix" style="background-image: url(resources/images/blog/unnamed.jpg)" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#story2">
<div class="display-table hw100 relative5">
<div class="display-table-cell hw100">
<div class="col-md-6 col-sm-8">
<div class="storyText text-center" data-center="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#story2 h1">
<h1>your fashion, your style</h1>
<h2>look the best, stand out from the rest</h2>
<p>Quisque et pulvinar sem, sit amet viverra erat. Mauris sed arcu quis orci ornare sagittis sit amet nec purus.</p>
<a class="btn btn-danger btn-story" href="#"> SHOP NOW</a> </div>
...
<div id="story3" class="story  clearfix" style="background-image: url(resources/images/blog/6629875515_a5fb1415db_b.jpg)" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-anchor-target="#story3">
<div class="display-table hw100 relative5">
<div class="display-table-cell hw100">
<div class="col-md-6 col-sm-8 center-col ">
<div class="storyText text-center" data-center="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#story3 h2">
<h1>your fashion, your style</h1>
<h2>look the best, stand out from the rest</h2>
<p>Quisque et pulvinar sem, sit amet viverra erat. Mauris sed arcu quis orci ornare sagittis sit amet nec purus.</p>
<a class="btn btn-danger btn-story" href="#"> SHOP NOW</a> </div>
...
<div id="story4" class="story  clearfix" style="background-image: url(resources/images/blog/unnamed3.jpg)" data-center="background-position: 50%  -100px;" data-top-bottom="background-position: 50% -200px;" data-anchor-target="#story4">
<div class="display-table hw100 relative5">
<div class="display-table-cell hw100">
<div class="col-md-6 col-sm-8 center-col ">
<div class="storyText text-center" data-center="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#story4 h2">
<h1>your fashion, your style</h1>
<h2>look the best, stand out from the rest</h2>
<p>Quisque et pulvinar sem, sit amet viverra erat. Mauris sed arcu quis orci ornare sagittis sit amet nec purus.</p>
<a class="btn btn-danger btn-story" href="#"> SHOP NOW</a> </div>
...
<div id="story5" class="story  clearfix" style="background-image: url(resources/images/blog/842708924_d175dd65ba_o.jpg)" data-center="background-position: 50%  -100px;" data-top-bottom="background-position: 50% -200px;" data-anchor-target="#story5">
<div class="display-table hw100 relative5">
<div class="display-table-cell hw100">
<div class="col-md-6 col-sm-8 center-col ">
<div class="storyText text-center" data-center="opacity: 1" data-106-top="opacity: 0" data-anchor-target="#story5 h1">
<h1>Sign up for free</h1>
<p>sign up for the latest info and get 10% off your shopping</p>
<div class="sform"> <input type="email" class="form-control" placeholder="enter email address" id="emilAdds" name="Email">
<a class="btn btn-danger btn-story-2 " href="#"> Sign Up Now <i class="fa fa-long-arrow-right"> </i> </a> </div></div>
</div>
</div>
...
<div class="main-image  col-lg-12 no-padding style3"> <a class="product-largeimg-link" href="product-details.html"><img src="resources/images/zoom/zoom1.jpg" class="img-responsive product-largeimg" alt="img"> </a> </div>
 
<div class="modal-product-thumb"> <a class="thumbLink selected"><img data-large="resources/images/zoom/zoom1.jpg" alt="img" class="img-responsive" src="resources/images/zoom/zoom1.jpg"> </a> <a class="thumbLink"><img data-large="resources/images/zoom/zoom2.jpg" alt="img" class="img-responsive" src="resources/images/zoom/zoom2.jpg"> </a> <a class="thumbLink"><img data-large="resources/images/zoom/zoom3.jpg" alt="img" class="img-responsive" src="resources/images/zoom/zoom3.jpg"> </a> </div>
...
<h4> <a class="inline" href="http://templatecycle.com/cdn-cgi/l/email-protection#deb6bbb2ae9eaaadb6b1aea9bbbcf0bdb1b3"> <i class="fa fa-envelope-o"> </i> <span class="__cf_email__" data-cfemail="2d4548415d6d595e45425d5a484f034e4240">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">
...
<script type="text/javascript" src="resources/assets/js/skrollr.min.js"></script>
...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:50:19 GMT -->
</html>
