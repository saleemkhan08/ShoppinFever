		...
		<div class="slider-content">
			...
			<div class="slider slider-v1" data-cycle-swipe=true
				...
				<div class="slider-item slider-item-img1">
					<img src="resources/images/slider/slider0.jpg"
				...
				<div class="slider-item slider-item-img3 ">
					...
					<img src="resources/images/slider/slider4.jpg"
						class="img-responsive parallaximg sliderImg" alt="img">
				</div>
					...
					<div class="sliderInfo">
						<div class="container">
							...
							<div
								...
								<div class="inner">
									<h1 class="uppercase topAnima animated ">10+ Amazing Color
										Theme</h1>
			...
			<div class="row xsResponse categoryProduct">
				<div class="item itemauto col-lg-3 col-md-3 col-sm-4 col-xs-6">
					<div class="product">
						...
						<div class="description">
							<h4>
								<a href="product-details.html"> Product Slider </a>
							</h4>
							...
							<div class="list-description">
								<p>Sed sed rutrum purus. Lorem ipsum dolor sit amet,
									consectetur adipiscing elit. Pellentesque risus lacus, iaculis
									in ante vitae, viverra hendrerit ante. Aliquam vel fermentum
									elit. Morbi rhoncus, neque in vulputate facilisis, leo tortor
									sollicitudin odio, quis pellentesque lorem nisi quis enim. In
									dolor mi, hendrerit at blandit vulputate, congue a purus. Sed
									eget turpis sit amet orci euismod accumsan. Praesent sit amet
									placerat elit.</p>
							</div>
							<span class="size">XL / XXL / S </span>
						</div>
				...
				<div class="item itemauto col-lg-3 col-md-3 col-sm-4 col-xs-6">
					<div class="product">
						...
						<div class="imageHover">
							<div id="carousel-id-2" class="carousel slide carousel-fade"
								data-ride="carousel">

								<ol class="carousel-indicators">
									<li data-target="#carousel-id-2" data-slide-to="0"
										class="active"></li>
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<a href="product-details.html"> <img
											src="resources/images/product/22.jpg" alt="img"
											class="img-responsive "></a>
									</div>
									<div class="item">
										<a href="product-details.html"> <img
									...
									<div class="item">
										<a href="product-details.html"> <img
											src="resources/images/product/18.jpg" alt="img"
											class="img-responsive "></a>
									</div>
								</div>

								<a class="left carousel-control" href="#carousel-id-2"
									role="button" data-slide="prev"> <span
									class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
									<span class="sr-only">Previous</span>
								</a> <a class="right carousel-control" href="#carousel-id-2"
									role="button" data-slide="next"> <span
									class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
									<span class="sr-only">Next</span>
								</a>
						...
						<div class="description">
							<h4>
								<a href="product-details.html"> Slider FadeIn </a>
							</h4>
							<div class="grid-description">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								</p>
				...
				<div class="item itemauto  col-lg-3 col-md-3 col-sm-4 col-xs-6">
					<div class="product">
						...
						<div class="imageHover">
							<a href="product-details.html"> <img
								src="resources/images/product/12.jpg" alt="img"
								class="img-responsive primaryImage"> <img
								src="resources/images/product/21.jpg" alt="img"
						...
						<div class="description">
							<h4>
								<a href="product-details.html"> Hover FadeIn </a>
							</h4>
							<div class="grid-description">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								</p>
				...
				<div class="item itemauto  col-lg-3 col-md-3 col-sm-4 col-xs-6">
					<div class="product">
						...
						<div class="imageHover imageHoverFlip">
							<a href="product-details.html"><img
								src="resources/images/product/7.jpg" alt="img"
								class="img-responsive primaryImage"> <img
								src="resources/images/product/13.jpg" alt="img"
								class="img-responsive secondaryImage"></a>
							<div class="promotion">
						...
						<div class="description">
							<h4>
								<a href="product-details.html"> Hover Flip </a>
							</h4>
							<div class="grid-description">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								</p>
			...
			<div class="row xsResponse">
				...
				<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
					<div class="product">
						...
						<div class="description">
							<h4>
								<a href="product-details.html">ullamcorper suscipit lobortis
								</a>
							</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
							<span class="size">XL / XXL / S </span>
			...
			<div
				...
				<div class="modal-details-inner">
					...
					<div class="product-price">
						<span class="price-sales"> $70</span> <span class="price-standard">$95</span>
					</div>
					<div class="details-description">
						<p>In scelerisque libero ut elit porttitor commodo Suspendisse
							laoreet magna.</p>
					</div>
