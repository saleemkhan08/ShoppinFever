...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:48:51 GMT -->
<head>
<meta charset="utf-8">
...
<body>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6 col-xs-6 col-md-6">
						<div class="pull-left ">
							<ul class="userMenu ">
								...
								<li class="phone-number"><a href="callto:+88016000000">
					...
					<div
						...
						<div class="pull-right">
							<ul class="userMenu">
								<li><a href="account-1.html"><span class="hidden-xs">
											My Account</span> <i
								...
								<li class="hidden-xs"><a href="#" data-toggle="modal"
									data-target="#ModalSignup"> Create Account </a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<table>
							<tbody>
								<tr class="miniCartProduct">
									...
									<td style="" class="miniCartSubtotal"><span> $8.80
									</span></td>
				...
				<div class="slider slider-v2">
					<div class="slider-item slider-item-img1 "
						...
						<div class="sliderInfo">
							<div class="container">
								<div
									class="col-lg-5 col-md-5 col-sm-5 pull-right sliderText dark alpha80 hidden-xs">
									<div class="inner">
										<h1>LATEST COLLECTION</h1>
										<p class="hidden-xs">Lorem ipsum dolor sit amet,
											consectetuer adipiscing elit, sed diam nonummy nibh euismod
											tincidunt ut laoreet dolore magna aliquam erat volutpa</p>
										<a href="category.html" class="slide-link">SHOP NOW <span
											class="arrowUnicode">►</span></a>
									</div>
								</div>
							</div>
						</div>
						<img alt="img" src="resources/images/slider/slider3.jpg"
							class="img-responsive parallaximg sliderImg">
					</div>

					<div class="slider-item slider-item-img2  parallax"
						data-cycle-pager-template="<a href=#> WOMEN COLLECTION </a>">
						<div class="sliderInfo">
							<div class="container">
								<div
									class="col-lg-5 col-md-5 col-sm-5 pull-left sliderText dark alpha80 hidden-xs">
									<div class="inner">
						...
						<img alt="img" src="resources/images/slider/slider4.jpg"
							class="img-responsive parallaximg sliderImg">
					</div>

					<div class="slider-item slider-item-img3  parallax"
						data-cycle-pager-template="<a href=#> NEW COLLECTION </a>">
						<div class="sliderInfo">
							<div class="container">
								<div
									class="col-lg-4 col-md-4 col-sm-5 pull-right sliderText dark alpha80 transformRight hidden-xs">
									<div class="inner">
						...
						<img alt="img" src="resources/images/slider/slider2.jpg"
							class="img-responsive parallaximg sliderImg">
					</div>
						...
						<div class="image">
							<div class="quickview">
								<a title="Quick View" class="btn btn-xs  btn-quickview"
									data-target="#product-details-modal" data-toggle="modal">
									Quick View </a>
							</div>
							<a href="product-details.html"><img
								src="resources/images/product/34.jpg" alt="img"
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/30.jpg" alt="img"
								class="img-responsive"></a>
							<div class="promotion">
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/36.jpg" alt="img"
								class="img-responsive"></a>
							<div class="promotion">
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/9.jpg" alt="img"
								class="img-responsive"></a>
						</div>
						<div class="description">
							<h4>
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/12.jpg" alt="img"
								class="img-responsive"></a>
						</div>
						<div class="description">
							<h4>
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/13.jpg" alt="img"
								class="img-responsive"></a>
						</div>
						<div class="description">
							<h4>
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/21.jpg" alt="img"
								class="img-responsive"></a>
						</div>
						<div class="description">
							<h4>
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/24.jpg" alt="img"
								class="img-responsive"></a>
						</div>
						<div class="description">
							<h4>
				...
				<div class="item">
					<div class="product">
						...
						<div class="image">
							...
							<a href="product-details.html"><img
								src="resources/images/product/15.jpg" alt="img"
								class="img-responsive"></a>
						</div>
						<div class="description">
							<h4>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/31.jpg" alt="img"
									class="img-responsive"></a>
								<div class="promotion">
									<span class="discount">15% OFF</span>
								</div>
							...
							<div class="description">
								<h4>
									<a href="product-details.html">ullamcorper suscipit
										lobortis </a>
								</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								</p>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/33.jpg" alt="img"
									class="img-responsive"></a>
							</div>
							<div class="description">
								<h4>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/10.jpg" alt="img"
									class="img-responsive"></a>
							</div>
							<div class="description">
								<h4>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/37.jpg" alt="img"
									class="img-responsive"></a>
							</div>
							<div class="description">
								<h4>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/35.jpg" alt="img"
									class="img-responsive"></a>
							</div>
							<div class="description">
								<h4>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/14.jpg" alt="img"
									class="img-responsive"></a>
								<div class="promotion">
									<span class="discount">15% OFF</span>
								</div>
					...
					<div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product">
							...
							<div class="image">
								...
								<a href="product-details.html"><img
									src="resources/images/product/17.jpg" alt="img"
									class="img-responsive"></a>
								<div class="promotion">
									<span class="new-product"> NEW</span>
								</div>
			...
			<div class="modal-content">
				...
				<div class="col-lg-5 col-md-5 col-sm-5  col-xs-12">
					...
					<div class="main-image  col-lg-12 no-padding style3">
						<a class="product-largeimg-link" href="product-details.html"><img
							src="resources/images/zoom/zoom1.jpg"
							class="img-responsive product-largeimg" alt="img"> </a>
					</div>

					<div class="modal-product-thumb">
						<a class="thumbLink selected"><img
							data-large="resources/images/zoom/zoom1.jpg" alt="img"
							class="img-responsive" src="resources/images/zoom/zoom1.jpg">
						</a> <a class="thumbLink"><img
							data-large="resources/images/zoom/zoom2.jpg" alt="img"
							class="img-responsive" src="resources/images/zoom/zoom2.jpg">
						</a> <a class="thumbLink"><img
							data-large="resources/images/zoom/zoom3.jpg" alt="img"
							class="img-responsive" src="resources/images/zoom/zoom3.jpg">
						</a>
					</div>
				</div>
				<div
					class="col-lg-7 col-md-7 col-sm-7 col-xs-12 modal-details no-padding">
					<div class="modal-details-inner">
						<h1 class="product-title">Lorem ipsum dolor sit amet</h1>
						<h3 class="product-code">Product Code : DEN1098</h3>
						<div class="product-price">
							<span class="price-sales"> $70</span> <span
								class="price-standard">$95</span>
						</div>
						<div class="details-description">
							<p>In scelerisque libero ut elit porttitor commodo
								Suspendisse laoreet magna.</p>
						</div>
						...
						<div class="cart-actions">
							<div class="addto">
								<button onclick="productAddToCartForm.submit(this);"
									class="button btn-cart cart first" title="Add to Cart"
					...
					<div class="col-lg-3  col-md-3 col-sm-4 col-xs-6">
						...
						<ul>
							<li class="supportLi">
								...
								<h4>
									<a class="inline" href="callto:+88016000000"> <strong>
											<i class="fa fa-phone"> </i> 88 0160 000 000
									</strong>
									</a>
								</h4>
								<h4>
									<a class="inline"
										href="http://templatecycle.com/cdn-cgi/l/email-protection#3b535e574b7b4f4853544b4c5e5915585456">
										<i class="fa fa-envelope-o"> </i> <span class="__cf_email__"
										data-cfemail="375f525b477743445f58474052551954585a">[email&#160;protected]</span>
	...
	<script type="text/javascript"
		src="resources/assets/js/ion-checkRadio/ion.checkRadio.min.js"></script>
	...
	<script type="text/javascript">
		/* <![CDATA[ */
				(
						function() {
							try {
								var s, a, i, j, r, c, l = document
										.getElementsByTagName("a"), t = document
								...
								for (i = 0; l.length - i; i++) {
									try {
										...
										if (a
												&& a
														.indexOf("/cdn-cgi/l/email-protection") > -1
												&& (a.length > 28)) {
											s = '';
											j = 27 + 1 + a
													.indexOf("/cdn-cgi/l/email-protection");
											if (a.length > j) {
...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:49:05 GMT -->
</html>
