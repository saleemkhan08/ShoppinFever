...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:43:00 GMT -->
<head>
<meta charset="utf-8">
...
<div class="col-sm-5 product-slide-left"> <a class="product-slide-img"> <img alt="img" src="resources/images/product/24.jpg" class="img-responsive"></a> </div>
<div class="col-sm-7">
...
<a title="Add to Cart" class="btn btn-stroke-dark"> <i class="glyphicon glyphicon-shopping-cart"></i> Add to Cart</a> </div>
</div>
</div>
<div class="product-slide">
<div class="col-sm-5 product-slide-left"> <a class="product-slide-img"> <img alt="img" src="resources/images/product/30.jpg" class="img-responsive"></a> </div>
<div class="col-sm-7 ">
<div class="product-slide-inner ">
<h1 class="product-title"> Lorem ipsum dolor sit amet</h1>
<h3 class="product-code">Product Code : DEN1098</h3>
...
<div class="product-slide">
<div class="col-sm-5 product-slide-left"> <a class="product-slide-img"><img alt="img" src="resources/images/product/a2.jpg" class="img-responsive"></a> </div>
<div class="col-sm-7 ">
<div class="product-slide-inner">
<h1 class="product-title"> Lorem ipsum dolor sit amet</h1>
<h3 class="product-code">Product Code : DEN1098</h3>
...
<div class="product-slide">
<div class="col-sm-5 product-slide-left"> <a class="product-slide-img"><img alt="img" src="resources/images/product/5.jpg" class="img-responsive"></a> </div>
<div class="col-sm-7 ">
<div class="product-slide-inner  ">
<h1 class="product-title"> Lorem ipsum dolor sit amet</h1>
<h3 class="product-code">Product Code : DEN1098</h3>
...
<div style="clear:both;"></div>
<a id="ps-next" class="ps-nav"> <i class="fa fa-angle-right"></i> </a> <a id="ps-prev" class="ps-nav"> <i class="fa fa-angle-left"></i> </a> </div>
...
<a href="product-details.html"><img src="resources/images/product/34.jpg" alt="img" class="img-responsive"></a>
...
<h4> <a class="inline" href="http://templatecycle.com/cdn-cgi/l/email-protection#0d6568617d4d797e65627d7a686f236e6260"> <i class="fa fa-envelope-o"> </i> <span class="__cf_email__" data-cfemail="6008050c10201413080f101705024e030f0d">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">
...
<!-- Mirrored from templatecycle.com/tshop/v-1.4/gray/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2015 10:45:00 GMT -->
</html>
